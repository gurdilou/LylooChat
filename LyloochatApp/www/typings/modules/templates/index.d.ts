declare namespace Lyloochat {
    class templates {
        ...
        static menu_drawing(context: any): string;
        ...
        static widget_floating_button(context: any): string;

        static menu_card_config(context: any): string;
